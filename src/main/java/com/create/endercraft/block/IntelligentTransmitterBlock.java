package com.create.endercraft.block;

import com.create.endercraft.ModBlockEntityTypes;
import com.create.endercraft.ModItems;
...
public class IntelligentTransmitterBlock extends Block implements EntityBlock {
    ...
    protected ItemInteractionResult useItemOn(ItemStack stack, BlockState state, Level level, BlockPos pos,
        ...
        if (stack.is(ModItems.TOOL_LINK_STATION_ITEM.get()) || stack.is(ModItems.SKILL_BOARD_ITEM.get())) {
            if (!level.isClientSide) {
                ...
                player.sendSystemMessage(Component.translatable("message.endercraft.network.bound", pos.toShortString()));
            }
    ...
    protected MenuProvider getMenuProvider(BlockState state, Level level, BlockPos pos) {
        return new SimpleMenuProvider(
                ...
                Component.translatable("screen.endercraft.transmitter.config")
        );
    }
