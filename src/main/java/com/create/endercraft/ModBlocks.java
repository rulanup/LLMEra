...
import com.create.endercraft.block.ToolLinkStationBlock;
import com.create.endercraft.block.SkillBoardBlock;

public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(Registries.BLOCK, EndercraftMod.MODID);
